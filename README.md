...
Інтерактивний квіз для підготовки до технічного інтервʼю QA-інженера. 8 тем, 650+ запитань, статистика прогресу. Двомовний: українська та англійська (перемикач `--lang` у хедері).
...
Разом: **654** запитання, кожне доступне українською та англійською.

## Фічі

- **Двомовність (i18n)** — повний переклад UI та всіх 654 питань англійською; мова перемикається кнопкою `--lang` будь-де, навіть посеред питання, і зберігається між сесіями
