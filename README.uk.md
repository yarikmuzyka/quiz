...
Інтерактивний квіз для підготовки до технічного інтервʼю QA-інженера. 10 тем, 844 запитання, статистика прогресу. Двомовний: українська та англійська (перемикач `--lang` у хедері).

**Спробувати: [yarikmuzyka.github.io/quiz](https://yarikmuzyka.github.io/quiz/)** — безкоштовно, без реєстрації, працює офлайн як PWA.
...
- **Build-бейдж на результатах** — оцінка у стилі shields.io: `PASSED · A` / `FAILED · F` після кожного прогону
